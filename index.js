...
function handleTontonNantiClick(fileCode, singleImg,title) {
  ...
  Swal.fire({
    icon: 'SUCCESS',
    title: 'BERHASIL DITAMBAHKAN VIDEO TERSIMPAN',
...
function fetchData(page) {
  ...
  fetch(`https://oakdoodserver.deno.dev/file/list?key=418098hn90f8ez0e6ssyg8&page=${page}&per_page=40`)
...
// Initial data fetch
fetch(`https://oakdoodserver.deno.dev/file/list?key=418098hn90f8ez0e6ssyg8&page=1&per_page=40`)
  .then(response => response.json())
  .then(data => {
