...
function handleTontonNantiClick(fileCode, singleImg,title) {
  ...
  fetch(`https://oakdoodserver.deno.dev/file/list?key=418098hn90f8ez0e6ssyg8&page=1&per_page=66`)
    ...
    .then(data => {
      ...
      return fetch(`https://oakdoodserver.deno.dev/file/list?key=418098hn90f8ez0e6ssyg8&page=${randomPage}&per_page=66`);
    })
    .then(response => response.json())
    .then(data => {
